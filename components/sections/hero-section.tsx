      ...
      <Container maxWidth="6xl">
        <div className="text-center relative z-10">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-slate-600 dark:text-slate-400 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              {[
                "100% Bepul",
                "Interaktiv Terminal", 
                "O'zbek Tilida",
                ...
                <div key={index} className="flex items-center gap-2 animate-scale-in" style={{ animationDelay: `${0.3 + index * 0.1}s` }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900 font-medium px-8 h-12 hover-lift git-card" 
                asChild
              >
                <Link href="/practice">
                  <Terminal className="mr-2 h-4 w-4" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              <div className="text-center animate-scale-in" style={{ animationDelay: '0.6s' }}>
                <div className="text-3xl font-bold mb-2 professional-gradient">15+</div>
                <div className="text-slate-600 dark:text-slate-400">Professional Dars</div>
              </div>
              <div className="text-center animate-scale-in" style={{ animationDelay: '0.7s' }}>
                <div className="text-3xl font-bold mb-2 professional-gradient">100%</div>
                <div className="text-slate-600 dark:text-slate-400">Bepul Platforma</div>
              </div>
              <div className="text-center animate-scale-in" style={{ animationDelay: '0.8s' }}>
                <div className="text-3xl font-bold mb-2 professional-gradient">2h</div>
                <div className="text-slate-600 dark:text-slate-400">O'rganish Vaqti</div>
              </div>
            </div>

            {/* Trust Indicators with subtle animation */}
            <div className="flex items-center justify-center gap-8 pt-8 text-sm text-slate-500 dark:text-slate-400 animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
