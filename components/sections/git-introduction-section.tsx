            ...
            {gitConcepts.map((concept, index) => (
              <Card key={index} className="git-card hover-lift glassmorphism-card dark:glassmorphism-card-dark animate-fade-in-up h-full" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardContent className="p-6 text-center h-full flex flex-col">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-4 leading-relaxed text-sm flex-grow">
                    {concept.description}
                  </p>
                  <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-3 mt-auto">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {gitBenefits.map((benefit, index) => (
              <Card key={index} className="git-card hover-lift glassmorphism-card dark:glassmorphism-card-dark animate-fade-in-up h-full" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardContent className="p-6 text-center h-full flex flex-col">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-50 to-emerald-50 dark:from-blue-950/30 dark:to-emerald-950/30 flex items-center justify-center mx-auto mb-4">
                    {benefit.icon}
                  </div>
                  <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">
                    {benefit.title}
